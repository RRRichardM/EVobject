...
class MyEnvironment(gym.Env):
    def __init__(self, render_mode: Optional[str] = None):
        ...
        self.max_episode_steps: int = 24 * 30 - 2
        ...
        self.observation_space = spaces.Dict(
            {
                "stations_remain_charge_state": spaces.MultiBinary(5),
    ...
    def reset(
        ...
        *,
        ...
        if not request:
            ...
            task = [request[0][0], request[0][1]]
        # state = {
        #     "stations_remain_charge_state": [
        #         EVstation.remain_charge_state for EVstation in self.EVSystem.EVstations
        #     ],
        #     "stations_power_remain": [
        #         EVstation.power_remain for EVstation in self.EVSystem.EVstations
        #     ],
        #     "stask": [task],
        # }
    ...
    def render(self, mode="human"):
        ...
        print("Current total_earn:", self.total_earn)
