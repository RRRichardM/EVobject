...
# 在test_sac_M.py中可以使用EVSystem类

# 接下来可以在test_sac_M.py中使用EVSystem类
...
def get_args():
    ...
    parser.add_argument("--alpha-lr", type=float, default=3e-3)
...
def test_discrete_sac(args=get_args()):
    ...
    train_envs = DummyVectorEnv(
        [lambda: MyEnvironment() for _ in range(args.training_num)]
    )
